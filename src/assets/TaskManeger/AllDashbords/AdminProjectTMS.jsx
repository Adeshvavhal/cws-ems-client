...
const API_URL = "https://cws-ems-server.vercel.app/api/projects";
  ...
  async function handleStatusChange(projectId, newStatus) {
    try {
      ...
      if (newStatus === "Completed") {
        apiUrl = `https://cws-ems-server.vercel.app/api/projects/${projectId}/complete`;
      } else if (newStatus === "Cancelled") {
        apiUrl = `https://cws-ems-server.vercel.app/api/projects/${projectId}/cancel`;
      }
