...
const TLTaskTMS = ({ role }) => {
  ...
  const fetchTaskComments = async (taskId) => {
    ...
    try {
      const response = await axios.get(
        `https://cws-ems-server.vercel.app/task/${taskId}/comments`,
      );
  ...
  const fetchTeamLeaderProjects = async (teamLeadId) => {
    try {
      const response = await axios.get(`https://cws-ems-server.vercel.app/${teamLeadId}/projects`);
  ...
  const fetchTasks = async () => {
    try {
      ...
      const res = await axios.get(`https://cws-ems-server.vercel.app/tasks/${teamLeadId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchEmployeesForProject = async (projectName) => {
    ...
    try {
      ...
      const projectsRes = await axios.get("https://cws-ems-server.vercel.app/api/projects", {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      if (selectedProject && selectedProject._id) {
        const empRes = await axios.get(
          `https://cws-ems-server.vercel.app/projects/employees/${selectedProject._id}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
  ...
  useEffect(() => {
    const fetchAddTaskRequiredDetails = async () => {
      try {
        ...
        const empRes = await axios.get(
          `https://cws-ems-server.vercel.app/employees/manager/${teamLeadId}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
        const taskTypeRes = await axios.get(
          `https://cws-ems-server.vercel.app/api/task-types/unique-names`,
        );
    ...
    const fetchWeeklyOffs = async () => {
      try {
        const res = await axios.get(
          `https://cws-ems-server.vercel.app/admin/weeklyoff/${new Date().getFullYear()}`,
        );
  ...
  async function handleAddTask(e) {
    ...
    try {
      ...
      const leaveRes = await axios.get(
        `https://cws-ems-server.vercel.app/leave/manager/${user._id}`,
      );
      ...
      const holidaysRes = await axios.get("https://cws-ems-server.vercel.app/getHolidays");
      ...
      if (editTaskId) {
        await axios.put(
          `https://cws-ems-server.vercel.app/task/${editTaskId}`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
        ...
        await axios.post(
          "https://cws-ems-server.vercel.app/task/create",
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleDeleteTask = async (id) => {
    ...
    try {
      await axios.delete(`https://cws-ems-server.vercel.app/task/${id}`);
  ...
  const handleEditSave = async (task) => {
    try {
      ...
      await axios.put(`https://cws-ems-server.vercel.app/task/${task._id}`, formData, {
        headers: {
