...
const trapFocus = (e) => {
  ...
  useEffect(() => {
    ...
    const fetchTasks = async () => {
      try {
        const res = await axios.get(`https://cws-ems-server.vercel.app/tasks/${managerId}`);
...
useEffect(() => {
  const fetchProjects = async () => {
    try {
      ...
      const res = await axios.get(`https://cws-ems-server.vercel.app/${userId}/projects`);
...
async function fetchRequiredDetails() {
  try {
    // Tasks
    const taskResponse = await axios.get(`https://cws-ems-server.vercel.app/tasks/${user._id}`);
    ...
    const projectsResponse = await axios.get(
      `https://cws-ems-server.vercel.app/${user._id}/projects`
    );
...
const calculateStatus = (project) => {
  ...
  useEffect(() => {
    const fetchTeamMembers = async () => {
      ...
      try {
        const response = await fetch(`https://cws-ems-server.vercel.app/${user._id}/members`);
