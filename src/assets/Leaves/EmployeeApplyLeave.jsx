...
function EmployeeApplyLeave({ user, onLeaveApplied }) {
  ...
  useEffect(() => {
    ...
    const fetchPublicHolidays = async () => {
      ...
      try {
        ...
        const res = await axios.get('https://cws-ems-server.vercel.app/getHolidays', {
    ...
    const fetchTeamLeaders = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://cws-ems-server.vercel.app/employee/${user._id}/team-leader`,
          {
            headers: { 'Authorization': `Bearer ${token}` }
          }
        );
  ...
  useEffect(() => {
    const fetchManager = async () => {
      ...
      try {
        ...
        const res = await axios.get(`https://cws-ems-server.vercel.app/users/${user.reportingManager}`);
    ...
    const fetchDays = async () => {
      ...
      try {
        const res = await axios.post(
          "https://cws-ems-server.vercel.app/leave/calculate",
          {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const existingLeavesRes = await axios.get(`https://cws-ems-server.vercel.app/leave/my/${user._id}`);
      ...
      await axios.post("https://cws-ems-server.vercel.app/leave/apply", {
        employeeId: user._id,
