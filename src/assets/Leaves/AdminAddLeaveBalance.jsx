...
function AdminAddLeaveBalance({fetchNotifications}) {
  ...
  useEffect(() => {
    axios
      .get("https://cws-ems-server.vercel.app/leaves")
      .then((res) => {
        const now = new Date();
  ...
  useEffect(() => {
    ...
    axios
      .get("https://cws-ems-server.vercel.app/me", {
  ...
  //   try {
  //     await axios.put(`https://cws-ems-server.vercel.app/leave/${leaveId}/status`, {
  //       status,
  //       userId: user._id,
  //       role: "admin",
  //     });
  ...
  //   try {
  //     const res = await axios.post("https://cws-ems-server.vercel.app/leave/grant-yearly", {
  //       sl,
  //       cl,
  //     });
  ...
  const fetchYearlySettings = async () => {
    try {
      const res = await axios.get(
        "https://cws-ems-server.vercel.app/leave/yearly-settings",
      );
      setData(res.data);
    } catch (err) {
  ...
  const grantMonthly = async () => {
    try {
      const res = await axios.post(
        "https://cws-ems-server.vercel.app/leave/grant-monthly",
        {
          sl,
          cl,
        },
  ...
  const fetchLeaveBalance = async () => {
    try {
      const res = await axios.get("https://cws-ems-server.vercel.app/leave/balance");
  ...
  const HandleDelete = async (leaveId) => {
    ...
    try {
      await axios.delete(`https://cws-ems-server.vercel.app/leave/${leaveId}`);
...
fetchNotifications();
  ...
  //   try {
  //     const res = await axios.post("https://cws-ems-server.vercel.app/leave/reset-all");
  ...
  const resetYearlySettings = async () => {
    ...
    try {
      const res = await axios.delete("https://cws-ems-server.vercel.app/leave/reset-all");
