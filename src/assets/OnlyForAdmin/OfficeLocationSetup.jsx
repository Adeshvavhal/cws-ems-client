...
//   useEffect(() => {
//     axios
//       .get("https://cws-ems-server.vercel.app/admin/office-location")
//       .then((res) => {
...
//   setLoading(true);
//   try {
//     await axios.post("https://cws-ems-server.vercel.app/admin/office-location", location);
...
function OfficeLocationSetup() {
  ...
  const handleSave = () => {
    ...
    axios
      .post("https://cws-ems-server.vercel.app/admin/office-location", editLocation)
      .then(() => {
