...
function EventsAndHolidaysDashboard() {
  ...
  const handleDeleteAnnouncement = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://cws-ems-server.vercel.app/announcements/${id}`, {
...
useEffect(() => {
  ...
  useEffect(() => {
    const fetchAnnouncements = async () => {
      try {
        const res = await axios.get("https://cws-ems-server.vercel.app/announcements/");
  ...
  const handleDeleteHoliday = async (id) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      await axios.delete(`https://cws-ems-server.vercel.app/holidays/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
    ...
    const fetchEvents = async () => {
      try {
        ...
        const res = await axios.get(
          "https://cws-ems-server.vercel.app/events-for-employee",
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        );
  ...
  const handleDeleteEvent = async (id) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      await axios.delete(`https://cws-ems-server.vercel.app/events/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
