...
//           axios.get(`https://cws-ems-server.vercel.app/attendance/${employeeId}`),
//           axios.get(`https://cws-ems-server.vercel.app/leave/my/${employeeId}`),
//           axios.get(`https://cws-ems-server.vercel.app/admin/weeklyoff/${new Date().getFullYear()}`),
//           axios.get(`https://cws-ems-server.vercel.app/getHolidays`),
//           axios.get(`https://cws-ems-server.vercel.app/attendance/regularization/my/${employeeId}`),
//         ]);
      ...
      try {
        const [attRes, leaveRes, weeklyRes, holidayRes, regRes] =
          await Promise.all([
            ...
            axios.get(`https://cws-ems-server.vercel.app/getHolidays`),
            axios.get(
              `https://cws-ems-server.vercel.app/attendance/regularization/my/${employeeId}`,
            ),
          ]);
        setWeeklyOff(weeklyRes.data.data?.saturdays || []);
        setHolidays(holidayRes.data || []);
