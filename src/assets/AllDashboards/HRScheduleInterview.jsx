...
const BASE_URL = "https://cws-ems-server.vercel.app";
...
const HRScheduleInterview = ({user}) => {
  ...
  useEffect(() => {
    axios
      .get("https://cws-ems-server.vercel.app/allEmp")
      .then((res) => {
  ...
  const fetchAllInterviews = () => {
    axios
      .get("https://cws-ems-server.vercel.app/interviews")
      .then((res) => {
        if (res.data.success) {
  ...
  const handleDeleteInterview = async (id) => {
    ...
    try {
      const res = await axios.delete(
        `https://cws-ems-server.vercel.app/interviewsDelete/${id}`,
      );
  ...
  const handleUpdateInterview = async (id, formData) => {
    ...
    try {
      const res = await axios.put(
        `https://cws-ems-server.vercel.app/interviewsUpdate/${id}`,
        formData, {
        headers: {
...
if (
  ...
  newErrors.link = "Interview link is required";
    ...
    const token = localStorage.getItem("accessToken");
    axios
      .post("https://cws-ems-server.vercel.app/schedule-interview", formPayload, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`
        },
