...
const EmployeeFeedback = () => {
  ...
  //     const response = await axios.get("https://cws-ems-server.vercel.app/gethr", {
  //       headers: {
  ...
  const fetchRecipients = async () => {
    try {
      ...
      // 1. Fetch HR users
      const hrResponse = await axios.get("https://cws-ems-server.vercel.app/gethr", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      try {
        const userResponse = await axios.get(
          `https://cws-ems-server.vercel.app/users/${currentUser._id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
      ...
      designation: manager.designation || "",
        ...
        if (userData.role && userData.role.toLowerCase() === "manager") {
          const employeesResponse = await axios.get(
            `https://cws-ems-server.vercel.app/managers/${currentUser._id}/assigned-employees`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
...
//----------------------------------------------------------------------------
              const tlResponse = await axios.get(
                "https://cws-ems-server.vercel.app/teamLead",
                {
...
//shivani code end--------------------------------------------------
        ...
        if (userData.role && userData.role.toLowerCase() === "team_leader") {
          const teamMembersResponse = await axios.get(
            `https://cws-ems-server.vercel.app/${currentUser._id}/members`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const fetchFeedbacks = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-ems-server.vercel.app/feedback/employee/${currentUser._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const markAsViewed = async (feedbackId) => {
    try {
      ...
      const response = await axios.put(
        `https://cws-ems-server.vercel.app/feedback/view/${feedbackId}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    try {
      ...
      if (editId) {
        response = await axios.put(
          `https://cws-ems-server.vercel.app/feedback/edit/${editId}`,
          {
        ...
        response = await axios.post(
          "https://cws-ems-server.vercel.app/feedback/send",
          {
  ...
  const handleDelete = async (id, e) => {
    ...
    try {
      const token = localStorage.getItem("accessToken");
      if (token) {
        await axios.delete(`https://cws-ems-server.vercel.app/feedback/delete/${id}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
