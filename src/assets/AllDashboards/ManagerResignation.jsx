...
useEffect(() => {
  ...
  const fetchResignations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-ems-server.vercel.app/resignation/manager/${managerId}`,
        {
          headers: {
  ...
  const handleDeleteResignation = async (resignationId) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://cws-ems-server.vercel.app/cancel/resignation/${resignationId}`,
        {
  ...
  const handleResignationAction = async (action) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://cws-ems-server.vercel.app/resignation/${selected.originalData.resignationId}`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleApplyResignation = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://cws-ems-server.vercel.app/resignation/apply",
        {
  ...
  const fetchMyResignations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-ems-server.vercel.app/resignation/${empId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
