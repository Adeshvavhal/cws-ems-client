...
const EmployeeCareer = ({ user }) => {
  ...
  const fetchAppliedJobs = async () => {
    try {
      const res = await fetch(
        `https://cws-ems-server.vercel.app/api/apply/employee/${user._id}?applicantType=inhouse`,
      );
  ...
  const fetchRefferedJobs = async () => {
    try {
      const res = await fetch(
        `https://cws-ems-server.vercel.app/api/apply/employee/${user._id}?applicantType=referral`,
      );
  ...
  const createApplication = (formData) =>
    axios.post("https://cws-ems-server.vercel.app/api/apply", formData, {
