...
function AdminCareer({ user }) {
  ...
  const fetchJobs = async () => {
    try {
      const res = await fetch("https://cws-ems-server.vercel.app/api/jobs/");
  ...
  async function handleSaveJob(e) {
    ...
    try {
      ...
      if (editJobId) {
        res = await axios.put(
          `https://cws-ems-server.vercel.app/api/jobs/${editJobId}`,
          payload,
        ...
        const res = await axios.post(
          "https://cws-ems-server.vercel.app/api/jobs/",
          payload,
          { headers: { "Content-Type": "application/json" } },
        );
        await fetchJobs();
  ...
  async function handleDelete(id, e) {
    ...
    try {
      await axios.delete(`https://cws-ems-server.vercel.app/api/jobs/${id}`);
  ...
  const getApplicantsInfo = async (jobId) => {
    try {
      ...
      const res = await fetch(`https://cws-ems-server.vercel.app/api/apply/job/${jobId}`, {
        method: "GET",
        headers: {
  ...
  async function handleStatusChange(applicationId, newStatus) {
    try {
      await axios.put(`https://cws-ems-server.vercel.app/api/apply/${applicationId}`, {
        status: newStatus,
      });
